...
function defineAccountActivatedTemplate(): EmailTemplate {
  return {
    ...
    render(variables: EmailTemplateVariables) {
      ...
      const serviceAreaLabel = escapeHtml(variables.pilotLabel ?? "Kano and Abuja service areas");
