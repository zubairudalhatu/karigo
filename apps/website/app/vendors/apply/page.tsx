  ...
  return (
    <main>
      <section className="section">
        ...
        <p className="lead">Restaurants, grocery stores, market sellers, pharmacies pending approval and service providers can apply. KariGO reviews all applications before onboarding.</p>
      </section>
