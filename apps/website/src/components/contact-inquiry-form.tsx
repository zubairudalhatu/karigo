...
export function ContactInquiryForm() {
  ...
  return (
    <form className="form-card inquiry-form" onSubmit={submit}>
      ...
      <p>Use this form to send a customer, vendor, Captain, Ride review or business inquiry. Do not include passwords, OTPs, payment details or sensitive private information.</p>
      <div className="form-grid">
        ...
        <label>Inquiry type<select value={form.inquiryType} onChange={(event) => setForm({ ...form, inquiryType: event.target.value })}>
          ...
          <option>Captain or Ride review inquiry</option>
