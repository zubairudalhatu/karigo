...
expect(registerReview.includes("registrationApi.submitVendorApplication") && registerReview.includes("partner-mobile-app"), "In-app registration review must submit application with mobile source metadata.");
