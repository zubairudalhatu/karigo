...
export interface VendorOrderSummary { id: string; orderNumber: string; customerName: string; serviceCategory: string; orderStatus: string; paymentStatus: string; totalAmount: string | number; deliveryAddress?: string | null; createdAt: string; itemsCount: number; availableActions: VendorAction[]; }
