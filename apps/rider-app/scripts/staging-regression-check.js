...
expect(taxiReadiness.includes("Licence expiry YYYY-MM-DD required"), "Taxi readiness must require licence expiry.");
expect(taxiReadiness.includes("Vehicle make required"), "Taxi readiness must require vehicle make.");
expect(taxiReadiness.includes("Vehicle model required"), "Taxi readiness must require vehicle model.");
expect(taxiReadiness.includes("Vehicle year required"), "Taxi readiness must require vehicle year.");
expect(taxiReadiness.includes("Vehicle colour required"), "Taxi readiness must require vehicle colour.");
expect(taxiReadiness.includes("Plate number required"), "Taxi readiness must require plate number.");
expect(taxiReadiness.includes("Complete all required verification and vehicle fields before submitting."), "Taxi readiness must block incomplete submissions.");
