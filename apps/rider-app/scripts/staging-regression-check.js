...
expect(captainModes.includes("ridesProductionEnabled"), "Ride Captain mode must stay gated by production Ride flags.");
...
expect(captainModes.includes("EXPO_PUBLIC_RIDES_PRODUCTION_ENABLED"), "Ride Captain mode helper must use the production Rides flag.");
expect(captainModes.includes("EXPO_PUBLIC_TAXI_SERVICE_ENABLED"), "Ride Captain mode helper must preserve the legacy Taxi service alias.");
...
expect(dashboard.includes("captainAccessApi.updateAvailability"), "Dashboard must update dual-mode availability through the backend work-state endpoint.");
expect(dashboard.includes("Delivery") && dashboard.includes("Ride"), "Dashboard must show independent Delivery and Ride availability controls.");
...
expect(taxiReadiness.includes("ridesProductionEnabled"), "Ride operations mode must use the shared production Ride flag helper.");
expect(taxiReadiness.includes("online Ride payment and payout automation remain disabled"), "Ride operations mode must show payment and payout safety copy.");
...
expect(taxiReadiness.includes("Decline assignment"), "Ride operations must allow a Captain to decline an assigned Ride with a reason.");
