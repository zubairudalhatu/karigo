...
export default function CaptainResetPasswordScreen() {
  ...
  return <Screen title="Enter OTP">
    <Text style={ui.pageIntro}>Enter the OTP sent to your KariGO phone number and choose a new password. KariGO will never ask you to share this OTP with anyone.</Text>
    <Field placeholder="080..." value={phoneNumber} onChangeText={setPhoneNumber} keyboardType="phone-pad" autoCapitalize="none" />
    <Field placeholder="OTP" value={otp} onChangeText={(value) => setOtp(value.replace(/\D/g, "").slice(0, 8))} keyboardType="number-pad" />
