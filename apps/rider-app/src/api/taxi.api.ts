...
export const taxiApi = {
  ...
  callSession: (tripId: string) => api.post<RideCallSession>(`rider/taxi/trips/${tripId}/call-session`),
  activeCallSession: (tripId: string) => api.get<RideCallSession | null>(`rider/taxi/trips/${tripId}/call-session/active`),
  acceptCall: (tripId: string, sessionId: string) => api.post<RideCallSession>(`rider/taxi/trips/${tripId}/call-sessions/${sessionId}/accept`),
  connectCall: (tripId: string, sessionId: string) => api.post<RideCallSession>(`rider/taxi/trips/${tripId}/call-sessions/${sessionId}/connected`),
  declineCall: (tripId: string, sessionId: string) => api.post<RideCallSession>(`rider/taxi/trips/${tripId}/call-sessions/${sessionId}/decline`),
  endCall: (tripId: string, sessionId: string, reason?: string) => api.post<RideCallSession>(`rider/taxi/trips/${tripId}/call-sessions/${sessionId}/end`, { reason }),
  renewCallToken: (tripId: string, sessionId: string) => api.post<RideCallSession>(`rider/taxi/trips/${tripId}/call-sessions/${sessionId}/token/renew`),
