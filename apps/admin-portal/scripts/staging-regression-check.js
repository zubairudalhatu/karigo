...
assert(taxiPage.includes("Pilot Ride Requests"), "Admin ride operations page must show controlled pilot ride requests.");
assert(taxiPage.includes("Ride Summary"), "Admin ride operations page must show Ride summary.");
assert(taxiPage.includes("automatic matching, ride payment and payout automation remain disabled"), "Admin ride operations page must state controlled pilot limits.");
...
assert(taxiPage.includes("Prepare Ride Captain profile"), "Admin ride operations page must allow preparing controlled-pilot Ride Captain profiles from approved applications.");
...
assert(taxiPage.includes("Cancel Pilot Ride"), "Admin ride operations page must support controlled pilot ride cancellation.");
