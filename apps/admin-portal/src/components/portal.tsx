...
const nav = [["Dashboard", "/"], ["Orders", "/orders"], ["Dispatch", "/dispatch"], ["Users", "/users"], ["Vendors", "/vendors"], ["Vendor Applications", "/vendor-applications"], ["Delivery Captain Applications", "/delivery-captain-applications"], ["Audit Logs", "/audit-logs"], ["Login Activity", "/login-activity"], ["Developer Settings", "/settings"], ["SME Services Summary", "/sme-services/summary"], ["SME Pilot Readiness", "/sme-services/readiness"], ["SME Launch Control", "/sme-services/launch-control"], ["SME Pilot Participants", "/sme-services/participants"], ["SME Invitation Templates", "/sme-services/invitation-templates"], ["SME Services", "/sme-services"], ["SME Provider Applications", "/sme-services/applications"], ["SME Providers", "/sme-services/providers"], ["Wallets", "/wallets"], ["Referrals", "/referrals"], ["Payout Accounts", "/payout-accounts"], ["Captains", "/riders"], ["Ride Operations", "/taxi"], ["Settlements", "/settlements"], ["Utilities", "/utilities"], ["Support", "/support"], ["Promotions", "/promotions"], ["Reports", "/reports"], ["Notifications", "/notifications"]];
