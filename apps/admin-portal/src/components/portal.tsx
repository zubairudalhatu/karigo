...
const nav = [["Dashboard", "/"], ["Orders", "/orders"], ["Dispatch", "/dispatch"], ["Users", "/users"], ["Vendors", "/vendors"], ["Vendor Applications", "/vendor-applications"], ["Payout Accounts", "/payout-accounts"], ["Riders", "/riders"], ["Settlements", "/settlements"], ["Utilities", "/utilities"], ["Support", "/support"], ["Promotions", "/promotions"], ["Reports", "/reports"], ["Notifications", "/notifications"]];
