...
const nav = [["Dashboard", "/"], ["Orders", "/orders"], ["Dispatch", "/dispatch"], ["Users", "/users"], ["Vendors", "/vendors"], ["Vendor Applications", "/vendor-applications"], ["SME Services", "/sme-services"], ["SME Provider Applications", "/sme-services/applications"], ["SME Providers", "/sme-services/providers"], ["Payout Accounts", "/payout-accounts"], ["Riders", "/riders"], ["Taxi", "/taxi"], ["Settlements", "/settlements"], ["Utilities", "/utilities"], ["Support", "/support"], ["Promotions", "/promotions"], ["Reports", "/reports"], ["Notifications", "/notifications"]];
