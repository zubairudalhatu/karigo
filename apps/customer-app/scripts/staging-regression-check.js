...
assert(home.includes("KariGO Rides"), "Home must include the KariGO Rides controlled pilot tile.");
...
assert(home.includes("Controlled pilot") && home.includes("Join waitlist"), "Ride tile must use controlled-pilot/waitlist copy.");
