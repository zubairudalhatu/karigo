...
assert(utilitiesHome.includes("Provider processing") && utilitiesHome.includes("Provider review"), "Utilities hub must distinguish provider-backed and review states.");
