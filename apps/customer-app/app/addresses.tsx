...
export default function Addresses() {
  ...
  const [form, setForm] = useState({ label: "Home", addressLine: "", city: "Kano", state: "Kano", deliveryNote: "" });
  ...
  async function create() {
    setError("");
    try { await addressesApi.create({ ...form, isDefault: items.length === 0 }); setForm({ ...form, addressLine: "", deliveryNote: "" }); await load(); }
