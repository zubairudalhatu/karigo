...
export default function Profile() {
  ...
  return <Protected>
    <KariGoAppTopBar title="Profile" rightAction={{ icon: "settings", label: "Profile settings" }} />
    <Screen title="Your profile" topPadding={false}>
      <Message error>{error}</Message>{profile ? <>
        ...
        <Card><Text style={ui.cardTitle}>Account actions</Text><NavLink href="/addresses" label="Saved addresses" /><NavLink href="/support" label="Support centre" /><NavLink href="/notifications" label="Notifications" /><NavLink href="/vendor/apply" label="Become a KariGO Vendor" /></Card>
